	...
	return (
		<div class="panel-wash rounded-[calc(var(--radius-soft)+0.25rem)] p-6 sm:p-8">
			...
			<p class="mt-4 max-w-2xl text-base leading-7 text-ink-subtle">
				The Illinois packet is the project&apos;s concrete policy model:
				one-pager, counsel-serious draft bill, and methodology memo aligned
				around disciplined, bond-financed reserve accumulation.
			</p>
