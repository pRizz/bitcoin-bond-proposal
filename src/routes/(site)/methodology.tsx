      ...
      >
        <div class="grid gap-4 lg:grid-cols-3">
          ...
          <div class="panel-wash rounded-[var(--radius-card)] p-5">
            ...
            <p class="mt-3 text-sm leading-6 text-ink-subtle">
              Primary legislative or authority records remain the floor for every
              publishable entry.
            </p>
          </div>
          <div class="panel-wash rounded-[var(--radius-card)] p-5">
            ...
            <p class="mt-3 text-sm leading-6 text-ink-subtle">
              Weak, symbolic, or only indirectly relevant records may still appear,
              but they will be labeled as such rather than inflated.
            </p>
          </div>
        </div>
      </PageSection>
